  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.nulls = iprot.readBinary() # self.nulls = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
...
class THandleIdentifier(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.guid = iprot.readBinary() # iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
          self.secret = iprot.readBinary() #iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.guid is not None:
      ...
      oprot.writeBinary(self.guid) # oprot.writeString(self.guid)
      oprot.writeFieldEnd()
    if self.secret is not None:
      oprot.writeFieldBegin('secret', TType.STRING, 2)
      oprot.writeBinary(self.secret) # oprot.writeString(self.secret)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class TExecuteStatementReq(object):
  ...
  def write(self, oprot):
    ...
    if self.statement is not None:
      ...
      oprot.writeBinary(self.statement) # oprot.writeString(self.statement)
      oprot.writeFieldEnd()
